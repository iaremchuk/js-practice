...
// class Circle {
//     constructor(centreCoordinateX, centreCoordinateY, radius) {
...
//     };
//     getCopy() {
//         return new Circle(this.centreCoordinateX, this.centreCoordinateY, this.radius);
//     };
//     static getCircleWithParametrs(centreCoordinateX, centreCoordinateY, radius) {
//         return new Circle(centreCoordinateX, centreCoordinateY, radius);
//     };
//     pointInsideTheCircle(x, y) {
//         return true ? (x - this.centreCoordinateX) ** 2 + (y - this.centreCoordinateY) ** 2 < this.radius ** 2 : false;
//     };
//     toString() {
//         return `centre coordinate x is ${this.centreCoordinateX}, centre coordinate y is ${this.centreCoordinateY}, circle radius is ${this.radius}`;
//     }
// }
...
//  - Також в класі Student необхідно реалізувати метод showCourse(), який виводитиме поточний курс 
// студента(від 1 до 6).Значення курсу визначатиметься як різниця поточного року(визначити самостійно) і року вступу до ВНЗ.
// Приклад результату:
...
//     };
//     print(text) {
//         const printCapacity = this.ink / 0.5;
//         console.log(`Text length is ${text.length}`);
//         let countNotSpaceSymbol = 0;
//         let textToPrint = '';
...
//                 this.ink -= 0.5;
//             };
//             if (countNotSpaceSymbol === printCapacity) {
//                 break;
//             };
//         };
//         console.log(`Ink level after printing the text is ${this.ink}%`);
//         return `In ${this.colour}: ${textToPrint}`;
//     };
// };
// class FilledMarker extends Marker {
//     fillMarker(){
//         return `Ink level is refilled to 100%`;
//     }
// }

// const markerOne = new FilledMarker("Red", 100);
// const markerTwo = new FilledMarker("Green", 100);
// console.log(markerOne);
// console.log(markerOne.print("I love spring. The weather is nice. The flowers blossom. The days are longer. The birds are singing. 
// It's my favourite season!"));
// console.log(markerOne.fillMarker());
// console.log(markerTwo);
// console.log(markerTwo.print("Inspirational Life Messages: Life is all about going through upward and all in to pursue our dreams. 
// Don’t let any kind of obstacle and failure pin you down or push you against your success in life. 
// Fight hard the battle of life and take the challenges with courage, determination, and perseverance. Just keep moving forward with 
// hope and this day is not so far when life will put the crown on your head as a successful human being."));
// console.log(markerTwo.fillMarker());
...
//     5) Створити кілька екземплярів класу(працівників) з різними зарплатами, як показано в прикладі нижче.Посортувати зарплату працівників
...
// allWorkers.sort((a, b) => a.showSalaryWithExperience() - b.showSalaryWithExperience());
